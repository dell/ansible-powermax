...
Become one of the contributors to this project! We thrive to build a welcoming and open community for anyone who wants to use the project or contribute to it. There are just a few small guidelines you need to follow. To help us create a safe and positive community experience for all, we require all participants to adhere to the [Code of Conduct](https://github.com/dell/ansible-powermax/blob/2.0.0/docs/CODE_OF_CONDUCT.md).
...
Read more about the ways you can [Triage issues](https://github.com/dell/ansible-powermax/blob/2.0.0/docs/ISSUE_TRIAGE.md).
...
* [Branching Strategy for Ansible modules for Dell PowerMax](https://github.com/dell/ansible-powermax/blob/2.0.0/docs/BRANCHING.md)
