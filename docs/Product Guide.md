                ...
                <div style="font-size: small">
                    <span style="color: purple">type=string</span>
                            ...
                            <td>
                                                            ...
                                                            <td>
                                        <div>The serial number of PowerMax/VMAX array. It is a required parameter for all array specific operations except for getting list of arrays in the Gatherfacts module.</div>
                                                    </td>
        </tr>
                            <tr>
                                                            <td colspan="1">
...
views, array health status and alerts, and so on.
                ...
                <div style="font-size: small">
                    <span style="color: purple">type=string</span>
                            ...
                            <td>
                                                            ...
                                                            <td>
                                        <div>The serial number of PowerMax/VMAX array. It is not required for getting list of arrays.</div>
                                                    </td>
        </tr>
				<tr>
                                                            <td colspan="2">
                ...
                <div style="font-size: small">
                    <span style="color: purple">type=boolean</span>
                            ...
                            <td>
                                                            ...
                                                            <td>
                                        <div>Boolean variable to filter the volume list. This will have a small performance impact. By default it is set to true, only TDEV volumes wil be returned.</div>
...
<table border=0 cellpadding=0 class="documentation-table">
    <tr>
        ...
        <th width="100%">Description</th>
            ...
            <td>success</td>
            <td>
                                        <div>List of different entities to measure SRP capacity.</div>
                                    <br/>
                                </td>
        </tr>
                                    <tr>
            ...
            <td>success</td>
            <td>
                                        <div>List of different entities to measure SRP efficiency.</div>
                                    <br/>
                                </td>
        </tr>
                                    <tr>
...
Managing hosts on a PowerMax storage system includes creating host
with a set of initiators and host flags, adding and removing
initiators to or from host, modifying host flag values, renaming
host, and deleting host.
                ...
                <div style="font-size: small">
                    <span style="color: purple">type=string</span>
                            ...
                            <td>
                                                            ...
                                                            <td>
                                        <div>Define whether the initiators should be present or absent in the host.</div>
                                        <div>present-in-host - indicates that the initiators should exist on host</div>
                                        <div>absent-in-host - indicates that the initiators should not exist on host</div>
...
group with set of hosts, adding or removing hosts to or from host group, renaming a
host group, modifying host flags of a host group, and deleting a host group.
                ...
                <div style="font-size: small">
                    ...
                    <span style="color: red">required=true</span>                    </div>
                            ...
                            <td>
                                        ...
                                        <div>present - indicates that the host group should be present on system</div>
                                        <div>absent - indicates that the host group should be absent on system</div>
                                                    </td>
        </tr>
                    </table>
<br/>
...
-   For renaming a masking view, the 'new\_mv\_name' is required. After a
    masking view is created, only its name can be changed. No underlying
    entity (portgroup, storagegroup, host or hostgroup) can be changed
    on the masking view.
...
Managing port groups on PowerMax storage system includes creating a
port group with a set of ports, adding or removing single or
multiple ports to or from port group, renaming port group,
and deleting port group.
