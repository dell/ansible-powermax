...
class PortGroup(object):
    ...
    def create_portgroup(self, portgroup_name):
        ...
        ports = self.module_wo_senstive_data['ports']
        port_state = self.module_wo_senstive_data['port_state']
        port_group_protocol = self.module_wo_senstive_data['port_group_protocol']
        try:
    ...
    def add_ports_to_portgroup(self, portgroup_name):
        ...
        try:
            ...
            add_ports = self.module_wo_senstive_data['ports']
    ...
    def remove_ports_from_portgroup(self, portgroup_name):
        ...
        try:
            ...
            if 'symmetrixPortKey' not in port_group:
                ...
                return False
            existing_ports = port_group["symmetrixPortKey"]
            rem_ports = self.module_wo_senstive_data['ports']
    ...
    def perform_module_operation(self):
        ...
        port_state = self.module_wo_senstive_data['port_state']
        portgroup_name = self.module_wo_senstive_data['portgroup_name']
        new_name = self.module_wo_senstive_data['new_name']
