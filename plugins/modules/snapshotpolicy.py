...
class SnapshotPolicy(object):
    ...
    def get_snapshotpolicy_details(self, snapshot_policy=None):
        ...
        try:
            if snapshot_policy:
                ...
                sp_name = self.module_wo_senstive_data['snapshot_policy_name']
            ...
            error_message = "Failed to get details of snapshot policy " \
                            "{0} with error {1}" \
                .format(self.module_wo_senstive_data['snapshot_policy_name'], str(e))
    ...
    def create_snapshotpolicy(self):
        ...
        try:
            resp = {}
            sp_name = self.module_wo_senstive_data['snapshot_policy_name']
            interval = self.module_wo_senstive_data['interval']
            offset_mins = self.module_wo_senstive_data['offset_mins']
            secure = self.module_wo_senstive_data['secure']
            snapshot_count = self.module_wo_senstive_data['snapshot_count']
            compliance_count_warning = self.module_wo_senstive_data[
                'compliance_count_warning']
            compliance_count_critical = self.module_wo_senstive_data[
                'compliance_count_critical']
    ...
    def is_snapshot_policy_modified(self):
        ...
        snapshot_policy_details = self.snapshot_policy.\
            get_snapshot_policy(self.module_wo_senstive_data['snapshot_policy_name'])
        LOG.debug("Snapshot Policy Details: %s", snapshot_policy_details)
        to_update = {}

        interval = self.module_wo_senstive_data['interval']
        new_snapshot_policy_name = self.module_wo_senstive_data[
            'new_snapshot_policy_name']
        secure = self.module_wo_senstive_data['secure']
        snapshot_count = self.module_wo_senstive_data['snapshot_count']
        offset_mins = self.module_wo_senstive_data['offset_mins']
        ...
        compliance_count_critical = self.module_wo_senstive_data[
            'compliance_count_critical']
        suspend = self.module_wo_senstive_data['suspend']
    ...
    def associate_SG_to_SP(self):
        ...
        try:
            sg_list = self.module_wo_senstive_data["storage_groups"]
            sp_name = self.module_wo_senstive_data['snapshot_policy_name']
    ...
    def perform_module_operation(self):
        ...
        sg_state = self.module_wo_senstive_data["storage_group_state"]
        storage_groups = self.module_wo_senstive_data['storage_groups']
        new_sp_name = self.module_wo_senstive_data['new_snapshot_policy_name']
